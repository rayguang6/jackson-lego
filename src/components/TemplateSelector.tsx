...
const TemplateSelector: React.FC<TemplateSelectorProps> = ({ section, onClose }) => {
  ...
  return (
    <div className="p-4 bg-white rounded-lg shadow-xl w-[360px] max-w-[90vw] border border-gray-200">
      ...
      <div className="grid grid-cols-2 gap-3 max-h-[350px] overflow-y-auto p-1">
        {templates.map((template) => (
          <div 
            key={template.id}
            className={`border rounded-md overflow-hidden cursor-pointer hover:border-indigo-500 transition-colors ${
