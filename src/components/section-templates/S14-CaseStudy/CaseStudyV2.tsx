...
export const CaseStudyV2: React.FC<CaseStudyProps> = ({
    ...
    <MySection theme={theme} className="py-16">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="space-y-8 mt-5 max-w-5xl mx-auto flex flex-col gap-8">
          {safeStudies.map((caseStudy, index) => (
            <div key={index} className="bg-white border border-gray-100 rounded-lg shadow-sm overflow-hidden"
              style={{ backgroundColor: theme === 'dark' ? '#ffffff08' : '#FFFFFF' }}
            >
              <div className="p-8 flex flex-col md:flex-row gap-8">
                ...
                <div className="flex-1">
                  ...
                  <div className="mb-4">
                    <MyParagraph theme={theme} className="font-medium">
                      <EditableText 
                        sectionId={sectionId} 
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    {Array.isArray(caseStudy.results) && caseStudy.results.map((result, resultIndex) => (
                      <div key={resultIndex}>
                        <MyParagraph theme={theme} className="!text-3xl font-bold text-red-600">
                          <EditableText 
                            sectionId={sectionId} 
                        ...
                        <MyParagraph theme={theme} className="">
                          <EditableText 
                            sectionId={sectionId} 
        ...
        <div className="mt-16 text-center">
          <PrimaryButton theme={theme} className="inline-flex items-center px-8 py-4 bg-red-600 text-white font-medium rounded-full hover:bg-red-700 transition-colors">
