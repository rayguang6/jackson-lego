...
export const GuaranteeV1: React.FC<GuaranteeProps> = ({
  ...
  return (
    ...
    >
      {/* Content */}
      <div style={{ backgroundColor: isDark ? '#ffffff08' : GLOBALCSS_VAR.primaryColor, borderRadius: '10px', border: isDark ? '1px solid #4B5162' : '' }} className={` z-10 flex flex-col md:flex-row justify-between items-center max-w-6xl mx-auto sm:px-6 lg:px-12 py-16 md:py-24 gap-8`}>
        ...
        <div className="flex flex-col max-w-xl">
          ...
          <MyParagraph style={{color: isDark ? '' : '#fff'}} className="mt-5">
            {/* EditableText */}
            <EditableText
              sectionId={sectionId}
