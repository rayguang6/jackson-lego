...
export const AboutV2: React.FC<AboutProps> = (props) => {
  const {
    title,
    subtitle,
    badgeText,
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="max-w-xl">
            ...
            {/* Quote */}
            {quote && (
              <div className="bg-red-50 border border-gray-100 p-8 rounded-lg">
                <div className="mb-4">
                  <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12.5 25H5L10 15H15L12.5 25Z" stroke="#EF083A" strokeWidth="2" />
                    <path d="M27.5 25H20L25 15H30L27.5 25Z" stroke="#EF083A" strokeWidth="2" />
                  </svg>
                </div>
                {quote.heading && <h3 className="text-xl font-medium text-red-600 mb-4">{quote.heading}</h3>}
                <p className="text-lg text-gray-800 mb-6">{quote.text}</p>
                <p className="text-sm text-gray-600">– {quote.author}, {quote.position}</p>
              </div>
            )}
          </div>
