...
export const FeaturesOrServicesV2: React.FC<FeaturesOrServicesProps> = ({
          ...
          {(services || []).slice(0, 4).map((service, index) => (
            ...
            >
              ...
              <div className="w-full md:w-3/5">
                {/* Keep the FEATURE # heading as is - not editable */}
                <MyHeading style={{color: GLOBALCSS_VAR.primaryColor}} as='h5' className="text-lg font-semibold mb-2">
                  <EditableText
                    sectionId={sectionId}
                    defaultValue={service.featureId || ''}
                    contentPath={`services.${index}.featureId`}
                  />
                </MyHeading>
